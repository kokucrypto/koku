...
#define FOUNDATION "BK4qMhAMNDShxoU38BJ3S26tczeMn7fNBD"
...
public:
    ...
    {
        // koku: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // koku: get transaction coin age
...
public:
    ...
    // koku: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // koku: two types of block: proof-of-work or proof-of-stake
    ...
    // koku: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // koku: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // koku: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // koku: block index flags
    enum  
    {
